                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            ...
                            <thead class="bg-gray-50">
                                ...
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">Número de pulsera</th>
                                <th scope="col" class="px-6 py-4 font-medium text-gray-900">Cuota - Editar</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-gray-700">{{ $nino->num_pulsera }}</div>
                                    </td>
