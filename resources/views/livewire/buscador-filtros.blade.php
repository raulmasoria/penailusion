<div class="bg-gray-100 py-10">
    <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold my-5">Busqueda de socios</h2>
        ...
        <form wire:submit.prevent='leerDatosFormulario'>
            <div class="mb-5 flex-auto">
                <input 
                    id="termino"
                    type="text"
                    placeholder="Buscar por nombre, apellido, email, telefono..."
                ...
                <a href="/socios" class="button bg-orange-500 mt-5 p-2 ml-5 inline-flex rounded-lg" >
                    Limpiar datos
                </a>
            </div>
        </form>    
