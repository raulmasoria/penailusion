<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Aquí puedes actualizar algunos de tus datos como el telefono,email o dirección postal.") }}
        </p>
        <p class="mt-1 text-sm text-gray-600">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="lastname" name="lastname" type="text" class="mt-1 block w-full" :value="old('lastname', $user->lastname)" required autofocus autocomplete="lastname" readonly/>
