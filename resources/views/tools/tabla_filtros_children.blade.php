                        ...
                        <section>
                            <header>
                                ...
                                <p class="mt-1 text-sm text-gray-600">
                                    {{ __("Aquí puedes filtrar y exportar listados de niños a tu gusto.") }}
                                </p>
                            </header>
                            <form method="GET" action="{{ route('childrens.filter') }}" class="bg-white p-6 rounded-lg shadow-md w-full">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Segunda fila: Responsable y su teléfono -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex flex-col w-full">
                                        ...
                                        <div class="flex flex-col w-full">
                                            <label class="text-orange-600 font-semibold">Teléfono responsable</label>
                                            <input type="text" name="filter_responsible_phone" placeholder="Teléfono" value="{{ request('filter_responsible_phone') }}"
                                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-300 p-2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex justify-end space-x-4">
                                        <a href="{{ route('childrens.filter') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md shadow hover:bg-gray-400">
                                            Limpiar datos
                                        </a>
