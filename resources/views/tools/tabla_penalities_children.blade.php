...
@section('contenido')
    ...
    <html>
    <head>
        <title>Penalizaciones de los niños</title>
                        ...
                        <section>
                            <header>
                                <h2 class="text-lg font-medium text-gray-900">
                                    {{ __('Listado de penalizaciones de los niños') }}
                                </h2>

                                <p class="mt-1 text-sm text-gray-600">
                                    {{ __("Aquí puedes filtrar y exportar listados de penalizaciones de los niños a tu gusto.") }}
                                </p>
                            </header>
                            <form method="GET" action="{{ route('niños.penalities') }}" class="bg-white p-6 rounded-lg shadow-md w-full">
                                <!-- Contenedor principal con espacio entre filas -->
                                <div class="space-y-4">
                                    <!-- Primera fila: Nombre y Apellido -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex flex-col w-full">
                                            <label class="text-orange-600 font-semibold">Nombre del niño</label>
                                        ...
                                        <div class="flex flex-col w-full">
                                            <label class="text-orange-600 font-semibold">Apellido del niño</label>
                                            <input type="text" name="filter_lastname" placeholder="Apellido" value="{{ request('filter_lastname') }}"
                                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-300 p-2">
                                        </div>
                                    </div>

                                    <!-- Segunda fila: Nombre y Teléfono del responsable -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex flex-col w-full">
                                        ...
                                        <div class="flex flex-col w-full">
                                            <label class="text-orange-600 font-semibold">Teléfono del responsable</label>
                                            <input type="text" name="filter_responsible_phone" placeholder="Teléfono" value="{{ request('filter_phone') }}"
                                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-300 p-2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="flex flex-col w-full">
                                            <div class="flex items-center">
                                                <label class="text-orange-600 font-semibold mr-2">Años de penalización</label>
                                            ...
                                            <select name="filter_penalty[]" multiple class="w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-300 p-2">
                                                @php
                                                    $years = [
                                            ...
                                            <span class="absolute top-0 right-0 p-2 text-gray-500 cursor-pointer" title="Selecciona los años para saber si ha sido penalizado.">
