...
<body lang="ES" link="blue" vlink="purple">
    <div class="WordSection1">
        ...
        <p>Aquí tienes tu nueva contraseña para que puedas disfrutar de la aplicación sin ningún problema.</p>
        <h2>{{ $passwd }}</h2>
        <p>Si continuas con problemas para poder acceder ponte en contacto con nosotros en el siguiente email: <a href="mailto:soriailusion@gmail.com">soriailusion@gmail.com</a></p>        
